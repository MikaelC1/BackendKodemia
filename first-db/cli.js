...
const KoderController = require('./koder')
const { DB_HOST, DB_USER, DB_PASS, DB_NAME } = process.env
const uri = `mongodb+srv://${DB_USER}:${DB_PASS}@${DB_HOST}/${DB_NAME}?retryWrites=true&w=majority&appName=Learing`
...
/*
    ...
    - resolve: resuelve la promesa(then)
